...
https://service.ilovepdf.com/v1/user url response-body false response-body true
  ...
  可改写为 Surge：
[Script] 
test = type=http-response,pattern=https://service.ilovepdf.com/v1/user,requires-body=1,script-path=https://raw.githubusercontent.com/myouhi/Surge/master/scripts/zhuhu/replace-body.js, argument=false->true
